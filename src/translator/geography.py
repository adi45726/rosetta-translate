...
LANGUAGE_ANCHORS: dict[str, tuple[str, float, float]] = {
    ...
    "yi": ("Warsaw", 52.23, 21.01),
    "zu": ("Durban", -29.86, 31.02),
    "xh": ("East London", -33.02, 27.91),
    "st": ("Maseru", -29.31, 27.48),
    "ha": ("Kano", 12.00, 8.52),
    "yo": ("Lagos", 6.52, 3.38),
    "ig": ("Enugu", 6.44, 7.50),
    "so": ("Mogadishu", 2.05, 45.32),
    "ps": ("Kabul", 34.53, 69.17),
    "sd": ("Karachi", 24.86, 67.01),
    "be": ("Minsk", 53.90, 27.57),
    "bs": ("Sarajevo", 43.86, 18.41),
